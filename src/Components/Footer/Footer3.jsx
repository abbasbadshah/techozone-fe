                  ...
                  <div className="row">
                    <div className="col-lg-8 m-auto text-center">
                      <div className="heading2">
                        ...
                        <p>At Ozone Software & Technologies IT Solutions, we are dedicated to delivering innovative technology solutions <br/> tailored to meet the unique needs of businesses like yours. </p>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="single-footer-items footer-logo-area">
                                ...
                                <div className="heading2">
                                    <p>At Ozone Software & Technologies IT Solutions, we are dedicated to delivering innovative technology solutions tailored to meet the unique needs of businesses like yours. </p>
                                </div>
